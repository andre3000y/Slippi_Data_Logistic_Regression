...
function handleActionCompute(state, indices, frame) {
    ...
    if (newAnimation) {
        ...
        incrementCount("groundTechCount.forward", currentAnimation === exports.State.FORWARD_TECH);
        incrementCount("groundTechCount.neutral", currentAnimation === exports.State.NEUTRAL_TECH);
        incrementCount("groundTechCount.backward", currentAnimation === exports.State.BACKWARD_TECH);
